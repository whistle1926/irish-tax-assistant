...
var USEFUL_LINKS = [
  { name: "Revenue.ie", url: "https://www.revenue.ie", desc: "Official Revenue Commissioners" },
  { name: "ROS Login", url: "https://www.ros.ie", desc: "Revenue Online Service" },
  { name: "myAccount", url: "https://www.ros.ie/myaccount-web/home.html", desc: "PAYE taxpayer self-service" },
  { name: "CRO.ie", url: "https://www.cro.ie", desc: "Companies Registration Office" },
  { name: "CRO Online (CORE)", url: "https://core.cro.ie", desc: "File returns and register companies" },
  { name: "Citizens Information", url: "https://www.citizensinformation.ie/en/money-and-tax/tax/", desc: "Tax guides in plain English" },
  { name: "Welfare.ie", url: "https://www.gov.ie/en/organisation/department-of-social-protection/", desc: "Social welfare and PRSI info" },
  { name: "LPT Online", url: "https://lpt.revenue.ie/lpt-web/views/login.html", desc: "Local Property Tax portal" },
  { name: "Tax Appeals Commission", url: "https://www.taxappeals.ie", desc: "Appeal a Revenue decision" },
  { name: "Irish Tax Institute", url: "https://www.taxinstitute.ie", desc: "Professional tax resources" },
  { name: "Enterprise Ireland", url: "https://www.enterprise-ireland.com", desc: "Supports for Irish businesses" },
  { name: "Local Enterprise Offices", url: "https://www.localenterprise.ie", desc: "Small business supports" },
];
        ...
        {showWelcome && (
          <div style={{ animation: "fadeSlideIn 0.5s ease-out" }}>
            ...
            <div style={{ marginBottom: "32px" }}>
              <p style={{ fontSize: "12px", fontWeight: 600, color: "#1B7B3E", textTransform: "uppercase", letterSpacing: "1.2px", marginBottom: "14px" }}>Useful Links</p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(230px, 1fr))", gap: "10px" }}>
                {USEFUL_LINKS.map(function(link, i) {
                  return (
                    <a key={i} href={link.url} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "12px", background: "#fff", borderRadius: "12px", padding: "12px 16px", border: "1px solid rgba(27,123,62,0.1)", textDecoration: "none", transition: "all 0.2s", boxShadow: "0 1px 4px rgba(0,0,0,0.02)" }}>
                      <div style={{ width: "36px", height: "36px", borderRadius: "10px", background: "linear-gradient(135deg, #e8f5e9, #f1f8f1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1B7B3E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <div style={{ minWidth: 0 }}>
                        <div style={{ fontWeight: 600, fontSize: "13.5px", color: "#0D3B1A" }}>{link.name}</div>
                        <div style={{ fontSize: "11.5px", color: "#6a8a6a", marginTop: "1px" }}>{link.desc}</div>
                      </div>
                    </a>
                  );
                })}
